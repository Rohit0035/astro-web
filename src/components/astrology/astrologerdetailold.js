...
class AstrologerDetail extends React.Component {
  ...
  componentDidMount() {
    ...
    axios  
      .get(`http://13.235.180.192:8000/user/astrodetails/${id}`)
      .then((response) => {
               ...
               <Row>
                   <Col md="3">
                       <div className="as-pic mt-30">
                          <img src={this.state.img} alt="women" className="pic-as"/>
                    ...
                    <Col md="6">
                      <div className="as-content mt-60">
                         ...
                         <ul>
                            <li>Language: <span>{this.state.language}</span></li>
                            <li>Experience: <span>{this.state.Exp}</span></li>
                            <li>Skills: <span>{this.state.Skills}</span></li>
                         </ul>
                       </div>
                    </Col>
