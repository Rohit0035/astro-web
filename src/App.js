...
const ShopGridKidsColumn = lazy(() => import('./pages/shop/ShopGridKidsColumn'))
...
const AddressFormEdit = lazy(() => import('./components/astrology/AddressFormEdit'))
          ...
          <ScrollToTop>
            ...
            >
              <Switch>
                ...
                />
                <Route
                  path={process.env.PUBLIC_URL + '/addressformedit'}
